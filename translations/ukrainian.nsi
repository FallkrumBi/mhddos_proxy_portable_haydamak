...
LangString inst_pf_req ${LANG_UKRAINIAN} "Шукач Проксі (Шукати проксі для mhddos_proxy)"
...
LangString inf_lable_1 ${LANG_UKRAINIAN} "	Для запуску haydamaks_installer на операційній системі Windows 7 необхідно інсталювати останні оновлення."
